...
define(
    'entries/service/channelmanage-through',['jquery','Class','entries/util/util'],
    function ($,Class,Util) {
        var waiting=Class.create(
            {
                ...
                bindpassinform:function(){
                    Util.ajaxData('channel/pass', 'POST', function (d, bool) {
                        if (bool) {
                            var channelcode=d.data.list[0].code;
                            $(".channel-thr-id label span").html(channelcode);
                        }
                    });
                }
            }
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-through'],
...
define("entries/action/channelmanage-subthrough.js", function(){});
