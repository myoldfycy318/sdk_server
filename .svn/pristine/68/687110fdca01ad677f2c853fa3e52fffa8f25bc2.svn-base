...
define(
    'entries/service/channelmanage-information',['jquery','Class','entries/util/util'],
    function ($,Class,Util) {
        var waiting=Class.create(
            {
                ...
                bindpassinform:function(){
                    Util.ajaxData('channel/query', 'POST', {},function (d, bool) {
                        if (bool) {
                            $("#channelname").html(d.data.name);
                            $("#channelemail").html(d.data.email);
                            $("#channelphone").html(d.data.mobilePhone);
                            $("#channelcontact").html(d.data.contact);
                            $("#channeladdress").html(d.data.address);
                            $("#channelbankcode").html(d.data.bankAccount);
                            $("#channelbeginbank").html(d.data.bankName);
                            $("#channelqq").html(d.data.qq);

                            if(d.data.cooperType==1){
                                $("#channeltype").html('CPA');
                            }
                            else if(d.data.cooperType==2){
                                $("#channeltype").html('CPS');
                            }
                        }
                    });
                }
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-information'],
...
define("entries/action/channelmanage-subinformation.js", function(){});
