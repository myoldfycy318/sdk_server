...
@Controller
@RequestMapping("/webgame/czdtx")
public class CzdtxController {
	public final Logger log = LoggerFactory.getLogger(this.getClass());

	public static final String LY = "qbao";

	public static final String LOGINKEY = "81qbaoe36258d7ac914aa9903dd595ac9d066a";

	public static final String PAYKEY = "81qbao35dfced487944e3197efb36c05559e00";
	
	public static final String OHTHERKEY="81qbaob184257f84a2432991fe455e35f377ca";

	public static final String LOGIN_URL = " http://gc.cz.kongzhong.com/czdtxly/loginlygameurl/{ly}/{key}";
//	public static final String LOGIN_URL = "http://118.242.26.158/czdtxly/loginlygameurl/{ly}/{key}";

	public static final String PAY_URL = "http://gc.cz.kongzhong.com/czdtxly/sendItemYb/{ly}/{key}";

//	public static final String PAY_URL = "http://118.242.26.158/czdtxly/sendItemYb/{ly}/{key}";
	
	public static final String CHECKROLE_URL = "http://gc.cz.kongzhong.com/czdtxly/userInfo/{ly}/{key}";

//	public static final String CHECKROLE_URL = "http://118.242.26.158/czdtxly/userInfo/{ly}/{key}";
...
//		String priceStr = df.format(price);
		...
		String signBase = LY + userId + zoneId + price.intValue() + num + orderNo + ptime + debug + PAYKEY;
		 log.info("原始sign:" + signBase);
