 ...
 */
define(
    'entries/service/application',['jquery', 'Class', 'entries/util/util', 'fileUpload', 'iCheck'],
...
require(
    ['jquery','entries/util/base','entries/service/application'],
...
define("entries/action/application.js", function(){});
