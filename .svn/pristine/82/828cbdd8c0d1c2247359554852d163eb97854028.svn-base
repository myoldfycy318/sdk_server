 ...
 */
define(
    'entries/service/index',['jquery','Class','entries/util/util'],
    function ($,Class,Util) {
            ...
            selectClick: function () {
                $(".select-btn").on("click", function () {
                   var val=$(this).attr('data-value');
                    window.location.href='submit-application.html?merchantRegType='+val;
                });
            }
        });
        return index;
...
require(
    ['jquery','entries/util/base','entries/service/index'],
    function ($,Base, Index) {
        $(function () {
            Base.init(function () {
                new Index();
...
define("entries/action/index.js", function(){});
