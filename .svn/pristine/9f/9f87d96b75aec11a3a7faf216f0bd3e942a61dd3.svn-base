...
/**
 * Created by leilihuang on 16/4/12.
 */
define(
    'entries/service/resetApplication',['jquery', 'Class', 'entries/util/util','fileUpload','template','iCheck'],
    function ($, Class, Util,WebUploader,template) {
        var index = Class.create(
            {
                ...
                initTplData: function () {
                  Util.ajaxData('merchant/toview','GET',{}, function (d, bool) {
                      if(bool){
                          var html=template('tpl-reset-html',d.data);
                          $('#reset-html').append(html);
                      }
                  })
                },
                bindClick: function () {
                ...
                submitBind: function () {
                    ...
                    $('.btn_sub').on('click', function () {
                        ...
                        if(_this.required!=0 && _this.agree_checked){
                            ...
                            Util.ajaxData('merchant/register','POST',data, function (d,bool) {
                                if(bool){
                    ...
                    $('input:text').each(function () {
                        if($(this).hasClass('required')){
                            if($(this).val()==''){
                                ...
                                if($(this).attr('data-name')=='merchantUrl'){
...
require(
    ['jquery','entries/util/base','entries/service/resetApplication'],
...
define("entries/action/resetApplication.js", function(){});
