...
define(
    'entries/service/channelmanage-applychannel',['jquery','Class','entries/util/util','template'],
        ...
        var waiting=Class.create(
            {
                ...
                clickapply:function(){
                    ...
                    $("#newchannel").click(function(){
                        ...
                        function reqLength($this){
                            if($this.attr('id') == 'channelname'){
                            ...
                            if($this.attr('id') == 'channelcontact'){
                        ...
                        if(errornum==0){
                            applydata={
                                ...
                                "cooperType":$("#channeltype input:checked").attr("data_name"),
                                "email":$("#channelemail").val(),
                                "mobilePhone":$("#channelphone").val(),
                                "qq":$("#channelqq").val(),
                                "contact":$("#channelcontact").val(),
                                "address":$("#channeladdress").val()
                            };
                            console.log(applydata);
                            Util.ajaxData('channel/save/2', 'POST',applydata ,function (d, bool) {
                                if(d.responseCode == 1000){
                                    Util.tipsAlert(null,'申请成功！','tips_success');
                                }
                            });
                        }
                    });
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-applychannel'],
...
define("entries/action/channelmanage-subapplychannel.js", function(){});
