...
public class PriceUtil {
     ...
     * 数字计算到小数点后2位，去0
     */
    public static String convert2YuanDelZero(Double price) {
        if (price == null) {
            return "0";
        }
        BigDecimal p = new BigDecimal(price / 100);
        return df.format(p);
    }
    ...
    public static void main(String arg[]) {
       Double price = Double.valueOf(1222);
       Double price1 = Double.valueOf(12);
        System.out.println(PriceUtil.convert2YuanD(new BigDecimal(price1)));
        System.out.println(PriceUtil.convert2YuanDelZero(price1));
        System.out.println(Double.valueOf(PriceUtil.convert2YuanDelZero(price1)));
        System.out.println(PriceUtil.convertToFen(price1));
    }
