...
public class RabbitMqServiceImpl implements RabbitMqService {
    ...
    @Override
    public void webPayNotifyQueue(OrderEntity orderEntity) {
        try {
            gameTemplate.convertAndSend("web_pay_queue_key", orderEntity);
        } catch (Exception e) {
            logger.error("页游支付异步通知添加rabbitmq异常，请求参数:{},", JSONObject.toJSONString(orderEntity), e);
        }
    }
}
