 ...
 */
define(
    'entries/service/appDetail',['jquery','Class','entries/util/util','template'],
    function ($,Class,Util,template) {
        var appDetail=Class.create(
            {
                ...
                requestData: function(){
                    Util.ajaxData('merchantapp/toview','POST',{appCode:this.param.appCode}, function (d, bool) {
                        if(bool){
...
require(
    ['jquery','entries/util/base','entries/service/appDetail'],
    function ($,Base, appDetail) {
        $(function () {
            Base.init(function () {
                new appDetail();
            });
...
define("entries/action/appDetail.js", function(){});
