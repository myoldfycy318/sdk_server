...
define(
    'entries/service/channelmanage-resrecord',['jquery','Class','entries/util/util','template','pages'],
        ...
        var waiting=Class.create(
            {
                ...
                resulttable:function(){
                   ...
                   Util.ajaxData('channel/settle/list', 'POST',datapost,function (d, bool) {
                        if (bool) {
                ...
                pageBind: function () {
                    ...
                    }.bind(this),this.pageNum);
                },
                pagenumclick:function(){
                    var _this = this;
                    $("body").on("click",".channel-numbtn",function(){

                        if(Number($(".channel-numtext").val()) > Math.ceil(_this.total/_this.pageSize)){
                            return false;
                        }                            

                        _this.pageNum=Number($(".channel-numtext").val())-1;
                        _this.datapost.pageNo=Number($(".channel-numtext").val());
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-resrecord'],
...
define("entries/action/channelmanage-subresrecord.js", function(){});
