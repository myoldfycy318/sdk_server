...
define(
    'entries/service/channelmanage-searchdata',['jquery', 'Class', 'entries/util/util', 'template', 'pages', '../jqinterface/jquery-ui.js', '../jqinterface/lightbullet.js'],
    function($, Class, Util, template) {
        var waiting = Class.create({
            ...
            downExeal:function(){
                ...
                $('#channel_exceldialogbutton_CPA').on('click',function(){
                    var _data = {
                        channelId:this.channelId,
                        cooperationType:this.cooperType
                    };                       
                    _data.beginDate = $("#channel_firsttime3").val() ? $("#channel_firsttime3").val(): this.table1.beginDate;
                    _data.endDate = $("#channel_lasttime3").val() ? $("#channel_lasttime3").val(): this.table1.endDate;
                    this.downExealData(_data);
                }.bind(this));
                $('#channel_exceldialogbutton').on('click',function(){
                     var _data = {
                        channelId:this.channelId,
                        cooperationType:this.cooperType
                    };                     
                    _data.beginDate = $("#channel_firsttime2").val() ? $("#channel_firsttime2").val(): this.table1.beginDate;
                    _data.endDate = $("#channel_lasttime2").val() ? $("#channel_lasttime2").val(): this.table1.beginDate;
                    this.downExealData(_data);
                }.bind(this));                
            },
            downExealData:function(data){
                var url = Poss.channelUrl+'/channel/balance/exportDetail?channelId='+data.channelId+'&beginDate='+data.beginDate+'&endDate='+data.endDate+"&domeAccessToken="+Util.cookie.dome_access_token;
                window.open(url);
            },
            resulttable: function(data) {
                var _data ={
                    pageNo:this.table1.pageNum + 1,
                    pageSize:this.table1.pageSize,
                    channelName: this.table1.channelName,
                    beginDate: this.table1.beginDate,
                    endDate: this.table1.endDate                 
                };
                Util.ajaxData('channel/balance/query', 'GET', _data, function(d, bool) {
                    if (bool) {
                        this.table1.total = d.data.totalCount;
                        d.data.pageNum = Util.pageStart(this.table1.pageNum, this.table1.pageSize, this.table1.total);
                        d.data.sizeTotal = Util.pageEnd(Number(d.data.list.length), Number(this.table1.pageNum), this.table1.pageSize);
                        var html = template('tpl_table', d.data),
                            pageCon = template('tpl_pageCon', d.data);
                        $('#tbody').empty().append(html);
                        $('#pageCon1').empty().append(pageCon);
                        this.table1.status = 0;
                        this.pageBind();
                    }
                }.bind(this));
            ...
            pageBind: function() {
                Util.pageBind(this.table1.total, this.table1.pageSize, function(i) {
                    if (this.table1.status == 0) {
                        this.table1.status = 1;
                    } else {
                        this.table1.pageNum = i;
                        this.resulttable();
                    }
                }.bind(this), this.table1.pageNum, "util_pages1");
            },
            pagenumclick: function() {
                var _this = this;
                $("body").on("click", ".channel-numbtn", function() {
                    if(Number($("#channel_numtext1").val()) > Math.ceil(_this.table1.total/_this.table1.pageSize)){
                        return false;
                    }                      

                    _this.table1.pageNum = Number($("#channel_numtext1").val()) - 1;

                    if (!isNaN(_this.table1.pageNum) && _this.table1.pageNum >= 0) {
                        _this.resulttable();
                    }
                });
            },
            datacontrol: function() {
                ...
                $("#channel_searchbutton").click(function() {
                    ...
                    if (firsttime > lasttime) {
                        ...
                        _this.table1.pageNum = 0;
                        _this.table1.channelName = $("#channel_role").val(),
                        _this.table1.beginDate = $("#channel_firsttime").val(),
                        _this.table1.endDate = $("#channel_lasttime").val()
                        _this.resulttable();
                    }
                });
            },
            seelinkdialog: function() {
                ...
                $("#channel_firsttime2").datepicker(Util.timeOptions);
                $("#channel_lasttime2").datepicker(Util.timeOptions);
                $("#channel_firsttime3").datepicker(Util.timeOptions);
                $("#channel_lasttime3").datepicker(Util.timeOptions);

                $(".channel-table").on("click", ".see-link", function(event) {
                    var $parents = $(this).parents('tr').find('td');
                        _this.channelId = $parents.eq(0).text();
                        _this.cooperType = $parents.eq(2).text() == 'CPA' ? '1' : '2';

                    _this.table2.pageNum = _this.table3.pageNum = 0;

                    $('#channel_firsttime2').val('');
                    $('#channel_lasttime2').val('');
                    $('#channel_firsttime3').val('');
                    $('#channel_lasttime3').val('');

                        _this.table2.beginDate=_this.table3.beginDate=_this.table1.beginDate,
                        _this.table2.endDate=_this.table3.endDate=_this.table1.endDate;

                    if (_this.cooperType == "2") {
                        _this.resulttable2();
                        $("#search_dialog").dialogff({ type: 'open', close: 'in', width: '710px' });
                    } else if (_this.cooperType == "1") {
                        _this.resulttable3();
                        $("#search_dialog_CPA").dialogff({ type: 'open', close: 'in', width: '710px' });                        
                    }
                ...
                $("body").on("click", "#channel_searchbutton2", function() {
                    var firsttime = parseInt($("#channel_firsttime2").val().replace(/-/g, ""));
                    var lasttime = parseInt($("#channel_lasttime2").val().replace(/-/g, ""));

                    if (firsttime > lasttime) {
                        Util.tipsAlert('提示信息', '起始时间必须小于最终时间', 'tips_error');
                    } else {
                        _this.table2.pageNum = 0;
                        _this.table2.beginDate=$("#channel_firsttime2").val();
                        _this.table2.endDate=$("#channel_lasttime2").val();                          
                        _this.resulttable2();
                    }
                });

                $("body").on("click", "#channel_searchbutton3", function() {
                    var firsttime = parseInt($("#channel_firsttime3").val().replace(/-/g, ""));
                    var lasttime = parseInt($("#channel_lasttime3").val().replace(/-/g, ""));

                    if (firsttime > lasttime) {
                        Util.tipsAlert('提示信息', '起始时间必须小于最终时间', 'tips_error');
                    } else {
                        _this.table3.pageNum = 0;
                        _this.table2.beginDate=$("#channel_firsttime3").val();
                        _this.table2.endDate=$("#channel_lasttime3").val(); 
                        _this.resulttable3();
                    }
                });
            },
            resulttable2: function() {
                var _data ={
                    pageNo:this.table2.pageNum + 1,
                    pageSize:this.table2.pageSize,
                    channelId: this.channelId,
                    beginDate: this.table2.beginDate,
                    cooperationType:this.cooperType,
                    endDate: this.table2.endDate                 
                };  
           
                Util.ajaxData('channel/balance/queryDetail', 'POST', _data, function(d, bool) {
                    if (bool) {
                        this.table2.total = d.data.totalCount;
                        d.data.pageNum = Util.pageStart(this.table2.pageNum, this.table2.pageSize, this.table2.total);
                        d.data.sizeTotal = Util.pageEnd(Number(d.data.list.length), Number(this.table2.pageNum), this.table2.pageSize);
                        var html = template('tpl_table2', d.data),
                            pageCon = template('tpl_pageCon2', d.data);
                        $('#tbody2').empty().append(html);
                        $('#pageCon2').empty().append(pageCon);
                        this.table2.status = 0;
                        this.pageBind2();
                    }else{
                        $("#search_dialog").dialogff({ type: 'close'});
                        $('#tbody2').empty();
                        $('#pageCon2').empty();
                    }
                }.bind(this));
            ...
            pageBind2: function() {
                Util.pageBind(this.table2.total, this.table2.pageSize, function(i) {
                    if (this.table2.status == 0) {
                        this.table2.status = 1;
                    } else {
                        this.table2.pageNum = i;
                        this.resulttable2();
                    }
                }.bind(this), this.table2.pageNum, "util_pages2");
            },
            pagenumclick2: function() {
                var _this = this;
                $("body").on("click", "#channel_numbtn2", function() {
                    if(Number($("#channel_numtext2").val()) > Math.ceil(_this.table2.total/_this.table2.pageSize)){
                        return false;
                    }     

                    _this.table2.pageNum = Number($("#channel_numtext2").val()) - 1;

                    if (!isNaN(_this.table2.pageNum) && _this.table2.pageNum >= 0) {
                        _this.resulttable2();
                    }
                });
            },
            resulttable3: function() {
                var _data ={
                    pageNo:this.table3.pageNum + 1,
                    pageSize:this.table3.pageSize,
                    channelId: this.channelId,
                    cooperationType:this.cooperType,
                    beginDate: this.table3.beginDate,
                    endDate: this.table3.endDate                 
                };  

                Util.ajaxData('channel/balance/queryDetail', 'POST', _data, function(d, bool) {
                    if (bool) {
                        console.log(d);
                        this.table3.total = d.data.totalCount;
                        d.data.pageNum = Util.pageStart(this.table3.pageNum, this.table3.pageSize, this.table3.total);
                        d.data.sizeTotal = Util.pageEnd(Number(d.data.list.length), Number(this.table3.pageNum), this.table3.pageSize);
                        var html = template('tpl_table3', d.data),
                            pageCon = template('tpl_pageCon3', d.data);
                        $('#tbody3').empty().append(html);
                        $('#pageCon3').empty().append(pageCon);
                        this.table3.status = 0;
                        this.pageBind3();
                    }else{
                        $("#search_dialog_CPA").dialogff({ type: 'close'});
                       $('#tbody3').empty();
                       $('#pageCon3').empty();
                    }
                }.bind(this));
            ...
            pageBind3: function() {              
                Util.pageBind(this.table3.total, this.table3.pageSize, function(i) {
                    if (this.table3.status == 0) {
                        this.table3.status = 1;
                    } else {
                        this.table3.pageNum = i;
                        this.resulttable3();
                    }
                }.bind(this), this.table3.pageNum, "util_pages3");
            },
            pagenumclick3: function() {
                var _this = this;
                $("body").on("click", "#channel_numbtn3", function() {
                    if(Number($("#channel_numtext3").val()) > Math.ceil(_this.table3.total/_this.table3.pageSize)){
                        return false;
                    }  

                    _this.table3.pageNum = Number($("#channel_numtext3").val()) - 1;

                    if (!isNaN(_this.table3.pageNum) && _this.table3.pageNum >= 0) {
                        _this.resulttable3();
                    }
                });
            }
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-searchdata'],
...
define("entries/action/channelmanage-subsearchdata.js", function(){});
