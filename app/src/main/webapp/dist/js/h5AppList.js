...
define('entries/service/h5AppList',[
    'jquery',
    'Class',
    'entries/util/util',
    'template',
    ...
    var app = Class.create({
        ...
        applyJr: function () {
            ...
            $('.apply_jr').on('click', function () {
                ...
                if (that.apply_status === "11") {
                    ...
                    $(that.els.alertBox + ' .alert-Box').html('').html(html);
                    $(that.els.alertBox).show();
        ...
        formHandle: function () {
            var items = ['payCallBackUrl', 'gameUrl'],
            ...
            return formHandle(items, selectorPrefix, '<span class="error red">*请输入正确的回调地址</span>');
        },
        //图片上传
...
require(
  ['jquery','entries/util/base','entries/service/h5AppList'],
  function ($,Base, App) {
    $(function () {
      Base.init(function () {
        new App();
...
define("entries/action/h5AppList.js", function(){});
