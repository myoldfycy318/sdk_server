...
define(
    'entries/service/channelmanage-nothrough',['jquery','Class','entries/util/util'],
    function ($,Class,Util) {
        var waiting=Class.create(
            {
                ...
                init: function (opts) {
                    ...
                    this.binderrorinform();
                },
                binderrorinform:function(){
                    Util.ajaxData('channel/query', 'POST',{}, function (d, bool) {
                        if (bool) {
                            var errormessage=d.data.remark,
                                url = 'channelmanage-subapply.html?channelCode='+d.data.channelCode;
                            $('#reset_btn').attr('href',url);
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-nothrough'],
...
define("entries/action/channelmanage-subnothrough.js", function(){});
