    ...
    var app = Class.create({
      setOptions: function (opts) {
        ...
        init: function (opts) {
          ...
          console.log('init webgameAddApp:' + this.appCode);
        ...
        getItem: function(appCode, isShow) {
          ...
          cb = function(d, bool) {
            if (bool) {
              this.renderForm($.extend({}, d.data, {isShow: isShow}));
            }
          }.bind(this);
        ...
        formHandle: function () {
          var items = ['appName', 'appIcon', 'appDesc', 't'],
...
/**
 * webgameAddApp Action
 */

require(
  ['jquery','entries/util/base','entries/service/webgameAddApp'],
  function ($,Base, App) {
    $(function () {
      Base.init(function () {
        new App();
...
define("entries/action/webgameAddApp.js", function(){});
