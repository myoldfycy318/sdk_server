...
define(
    'entries/service/channelmanage-applyrecord',['jquery','Class','entries/util/util','template'],
        ...
        var waiting=Class.create(
            {
                ...
                applydata:function(){
                   Util.ajaxData('channel/settle/query', 'POST',{} ,function (d, bool) {
                        if (bool) {
                            var month=d.data.month;
                            var price=d.data.amount;
                            
                            $(".apply-r-ul .yearword").html(month);
                            $(".apply-r-ul .priceword").html(price);
                ...
                clickapply:function(){
                    $("#apply_btn .subapply").click(function(){
                        Util.ajaxData('channel/settle/apply', 'POST',{} ,function (d, bool) {
                            if(bool){
                                Util.tipsAlert(null,'申请结算成功','tips_text');
                            }
                        });
                    });
...
require(
    ['jquery','entries/util/base','entries/service/channelmanage-applyrecord'],
...
define("entries/action/channelmanage-subapplyrecord.js", function(){});
